...
<template>
  <nav
    class="game-navbar top-0 inset-x-0 fixed h-14 z-30 transition-position w-screen lg:w-auto"
  >
    <div class="flex lg:items-stretch" :class="containerMaxW">
      <div class="flex flex-1 items-stretch h-14">
        <slot />
      </div>
      <div v-if="menu.length" class="flex-none items-stretch flex h-14 lg:hidden">
